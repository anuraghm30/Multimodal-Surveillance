...
Combines visual data with analytical models for better detection.

⚠️ Anomaly Detection
Detects unusual activities or suspicious behavior in monitored areas.

📊 Real-Time Frame Processing
Uses computer vision algorithms to analyze frames.
...
Used to detect anomalies and analyze surveillance data.
Python
Scikit-learn
